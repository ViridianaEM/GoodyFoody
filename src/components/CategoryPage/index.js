                            ...
                            return <Fragment key={data.idCategory}>
                                <div className="p-4 md:w-1/3">
                                    <div className="h-full  rounded-lg overflow-hidden">
                                        ...
                                        <div className="p-6">
                                            <h2 className="tracking-widest text-xs title-font font-medium text-greygf mb-1">CATEGORY</h2>
                                            <h1 className="title-font text-lg font-medium text-bluegf mb-3">{data.strCategory}</h1>
                                            ...
                                            <div className="flex items-center flex-wrap justify-end">
                                                <Link
                                                    ...
                                                    className="text-browngf inline-flex   items-center md:mb-2 lg:mb-0" >
